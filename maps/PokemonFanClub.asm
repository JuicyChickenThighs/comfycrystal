...
PokemonFanClubIvysaurScript:
	opentext
	writetext FanClubIvysaurText
	cry IVYSAUR
	waitbutton
	closetext
	end
...
PokemonFanClub_MapEvents:
	...
	object_event  7,  3, SPRITE_ODDISH, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, PokemonFanClubIvysaurScript, -1

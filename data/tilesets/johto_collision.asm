	...
	tilecoll DIAGONAL_STAIRS_LEFT, DIAGONAL_STAIRS_LEFT, DIAGONAL_STAIRS_LEFT, DIAGONAL_STAIRS_LEFT ; 80
	tilecoll DIAGONAL_STAIRS_RIGHT, DIAGONAL_STAIRS_RIGHT, DIAGONAL_STAIRS_RIGHT, DIAGONAL_STAIRS_RIGHT ; 81
